...
tmp1 <- "/Users/gazallab/Desktop/PM566/Git/Assignment_2/HW2Git/Assignment2/chs_indiv.csv"
if (!file.exists(tmp1)) {
  download.file(
    url      = chs_indiv_url,
    destfile = tmp1,
...
chs_indiv<- fread("/Users/gazallab/Desktop/PM566/Git/Assignment_2/HW2Git/Assignment2/chs_indiv.csv")

chs_region_url <- "https://raw.githubusercontent.com/USCbiostats/data-science-data/master/01_chs/chs_regional.csv"
tmp2 <- "/Users/gazallab/Desktop/PM566/Git/Assignment_2/HW2Git/Assignment2/chs_region.csv"
if (!file.exists(tmp2)) {
  download.file(
    url      = chs_region_url,
    destfile = tmp2,
...
chs_reg <- fread("/Users/gazallab/Desktop/PM566/Git/Assignment_2/HW2Git/Assignment2/chs_region.csv", header = T)
```
